...
public class EmployeesDao extends Employees implements DaoInterface<Employees> {
	...
	@Override
	public Employees save(Employees table) {
		return table;
	...
	@Override
	public Employees update(Employees table, String[] params) {
		return table;
		// TODO Auto-generated method stub
	...
	@Override
	public oracleDBA.Employees get_name(oracleDBA.Employees t) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public oracleDBA.Employees get_id(oracleDBA.Employees t) {
		// TODO Auto-generated method stub
		return null;
	}
